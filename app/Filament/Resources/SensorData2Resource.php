...
use App\Filament\Resources\SensorData2Resource\Pages;
use App\Filament\Resources\SensorData2Resource\RelationManagers;
...
class SensorData2Resource extends Resource
{
    protected static ?string $model = SensorData2::class;

    protected static ?string $navigationIcon = 'heroicon-o-trash';
    protected static ?string $navigationGroup = 'Sensor Data';
    protected static ?string $navigationLabel = 'Tempat Sampah 2';
    protected static ?string $modelLabel = 'Data Tempat Sampah 2'; // Form/Detail
    protected static ?string $pluralModelLabel = 'Tempat Sampah 2';
    ...
    public static function table(Table $table): Table
{
    ...
    {
        return [
            'index' => Pages\ListSensorData2s::route('/'),
            'create' => Pages\CreateSensorData2::route('/create'),
            'edit' => Pages\EditSensorData2::route('/{record}/edit'),
        ];
    }
}
