...
use App\Filament\Resources\SensorData7Resource\Pages;
use App\Filament\Resources\SensorData7Resource\RelationManagers;
...
class SensorData7Resource extends Resource
{
    protected static ?string $model = SensorData7::class;

    protected static ?string $navigationIcon = 'heroicon-o-trash';
    protected static ?string $navigationGroup = 'Sensor Data';
    protected static ?string $navigationLabel = 'Tempat Sampah 7';
    protected static ?string $modelLabel = 'Data Tempat Sampah 7'; // Form/Detail
    protected static ?string $pluralModelLabel = 'Tempat Sampah 7';
    ...
    public static function table(Table $table): Table
{
    ...
    {
        return [
            'index' => Pages\ListSensorData7s::route('/'),
            'create' => Pages\CreateSensorData7::route('/create'),
            'edit' => Pages\EditSensorData7::route('/{record}/edit'),
        ];
    }
}
