...
class ListSensorData8s extends ListRecords
{
    ...
    {
        $resetAt = optional(SensorReset::where('sensor_name', 'sensor_data8')->first())->reset_at;

        $query = SensorData8::query();
