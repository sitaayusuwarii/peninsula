...
//         // Ini adalah solusi sementara untuk error cURL 77 (verifikasi SSL)
//         // JANGAN GUNAKAN INI DI LINGKUNGAN PRODUKSI!
//         $response = Http::withoutVerifyingSsl()->post("https://api.telegram.org/bot{$token}/sendMessage", [
//             'chat_id' => $chatId,
//             'text' => $message,
//             'parse_mode' => 'Markdown', // Atau 'HTML' jika Anda menggunakan HTML
//         ]);

//         if ($response->failed()) {
//             Log::error('Gagal kirim ke Telegram: ' . $response->body() . ' Status: ' . $response->status());
//         } else {
//             Log::info('Pesan Telegram berhasil dikirim.', ['response' => $response->json()]);
//         }
//     }
// }
